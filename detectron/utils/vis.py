...
# PMB -- borrowed from http://www.icare.univ-lille1.fr/tutorials/convert_a_matplotlib_figure
# Converts a matplotlib figure to a numpy array, useful for overlaying body skeletons
# (plotted via matplotlib) on DensePose meshes (which are stored as numpy arrays)
def fig2data ( fig ):
    """
